//
// WOSpan.java: Class file for WO Component 'WOSpan'
...
public class WOSpan extends WODynamicElement {
    private static final Logger     	logger = Logger.getLogger (WOSpan.class);
    ...
    public WOSpan(String aName, NSDictionary<String, WOAssociation> anAssociationsDict, WOElement anElement) {
        super(aName, null, anElement);

        // "WOSpan: name=com.ramsayconz.wocore.woc.WOSpan, 
